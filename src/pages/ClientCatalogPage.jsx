...
// Usa onSnapshot do controller para manter em sync
...
export default function ClientCatalogPage() {
  ...
  const handleFinalizarPedido = async () => {
    ...
    try {
      ...
      // 2. Debita estoque de cada cerveja
  ...
  return (
    <div style={{ maxWidth: 1200, margin: "0 auto", padding: 24 }}>
      ...
      <div style={{ display: "flex", gap: 12, marginBottom: 24, flexWrap: "wrap" }}>
        <input
          className="input"
          style={{ flex: 1, minWidth: 260, background: "#0f1109", border: "1px solid #2a2510", borderRadius: 8, padding: "10px 12px", color: "#e2e8f0", fontSize: 14 }}
        ...
        <select
          className="input"
          style={{ maxWidth: 220, background: "#0f1109", border: "1px solid #2a2510", borderRadius: 8, padding: "10px 12px", color: "#e2e8f0", fontSize: 14 }}
          value={filtroEstilo}
                  ...
                  >
                    <div>
                      ...
                      <p style={{ margin: "6px 0 0", fontSize: 13, color: "#aaa" }}>
                        ...
                        <span style={{ color: "#22c55e" }}>= R$ {(item.quantidade * item.preco).toFixed(2)}</span>
                      </p>
                    </div>
